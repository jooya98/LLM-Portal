...
// #788: provider-level failures are symptoms of the PROVIDER being sick, not of this
...
// token count, a duration, or a key-scoped message naming an unavailable model
// would each condemn a healthy platform for the whole request.
